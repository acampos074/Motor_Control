...
#define SERV_0_HEADER "FSM.h"
// the name of the Init function
#define SERV_0_INIT InitFSM
// the name of the run function
#define SERV_0_RUN RunFSM
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4CANRx
